<template >
    <div class="tb-bg-main" >
        <div>
            <button class="btn btn-primary px-5 rounded-0 text-center tb-space"><strong> CURRENT SERIES </strong></button>
        </div>

        <div class="container">
            <div class="row pt-5 d-flex ">
                <div class="col d-flex" v-for="card in cards">
                    <div class="card rounded-0 bg-black border-0" style="width: 12rem;" >
                        <img class="card-img-top rounded-0 " :src="card.thumb" alt="Card image cap">
                        <div class="card-body tb-bg-main tb-format">
                            <p class="card-text text-light">{{card.series}}</p>
                        </div>                    
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center">
            <button class="btn btn-primary px-5 mb-5 rounded-0 text-center"> LOAD MORE </button>
        </div>
    </div>
</template>
